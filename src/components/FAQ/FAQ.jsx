...
const FAQ = () => {
	return (
		<Element
			name="faq-section"
			className="my-24 max-w-[1440px] mx-auto px-2"
		>
			<h2 className="text-3xl font-bold text-primaryText mt-8 mb-4 text-center">
			...
			<div className="space-y-4">
				{faqs.map((faq, index) => (
					<div
						key={index}
						className="collapse collapse-arrow bg-secondaryAccent shadow-md rounded-lg"
					>
